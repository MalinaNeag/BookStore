...
public class CrimeBookPageManagerController {
    ...
    ArrayList<Item> crimeBooks = new ArrayList<>(9);
    private int crimeNo = 0;

    public CrimeBookPageManagerController() {
    }
    ...
    private void deleteItem(int index)throws IOException{
        ItemsList.getItems().remove(crimeBooks.get(index));
        crimeBooks.remove(index);
        crimeNo =0;
        ItemsList.decreaseCategoryNo("crime");
        Main m= new Main();
    ...
    /*private static CrimeBookPageManagerController instance = null;

    public static CrimeBookPageManagerController getInstance() {
        return instance;
    }*/
